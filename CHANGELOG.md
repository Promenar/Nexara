...
- **真机反馈候选验真**：当前工作树完成 1665 项 JVM 测试、36/36 截图、Lint、Debug/deviceTest 构建及 21 项针对性设备回归（1 项分阶段 force-stop 用例按设计跳过）。稳定证书签名 R8 APK 为 17,987,619 bytes，SHA-256 `798fb92972c9fd11cf40ab415dbe497092837728c89d317b0175a1636994f53b`；API 36 完成验证、冷安装、设备 APK 字节回读、冷启动和 crash/ANR 观察。

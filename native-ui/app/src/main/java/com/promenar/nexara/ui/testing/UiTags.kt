...
object UiTags {
    ...
    const val RAG_SEARCH_RESULTS = "RAG_SEARCH_RESULTS"
    const val RAG_SEARCH_WARNING = "RAG_SEARCH_WARNING"
    const val RAG_SEARCH_BODY_MATCH = "RAG_SEARCH_BODY_MATCH"
    const val RAG_SEARCH_TITLE_FALLBACK = "RAG_SEARCH_TITLE_FALLBACK"
    const val RAG_SEARCH_RESULT_PREFIX = "RAG_SEARCH_RESULT:"
    const val KG_CANVAS = "KG_CANVAS"
    const val KG_ACCESSIBILITY_LIST = "KG_ACCESSIBILITY_LIST"
    const val KG_ACCESSIBILITY_RELATION_PREFIX = "KG_ACCESSIBILITY_RELATION:"
    const val KG_LIST_ENTRY = "KG_LIST_ENTRY"
    const val KG_DOCUMENT_SELECTOR = "KG_DOCUMENT_SELECTOR"

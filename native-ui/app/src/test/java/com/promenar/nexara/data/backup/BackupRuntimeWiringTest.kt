...
class BackupRuntimeWiringTest {
    ...
    fun `all business writers live behind one transactional ready-only initializer`() {
        ...
        val legacyIdentityAdoption = recovery.indexOf("LegacyWorkspaceRootAdoptionCoordinator(")
        ...
        assertThat(legacyIdentityAdoption).isAtLeast(0)
        assertThat(legacyIdentityAdoption).isLessThan(journal)

...
export function MessageActions({ message }: MessageActionsProps) {
  ...
  return (
    <div className="message-actions">
      <button className="action-btn" onClick={handleCopy} title="复制内容">
      ...
      <button className="action-btn" onClick={handleShare} title="分享消息">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {isUser ? (
        <button className="action-btn" onClick={handleResend} title="重新发送">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <>
          <button className="action-btn" onClick={handleExtractGraph} title="知识图谱">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button className="action-btn" onClick={handleVectorize} title="向量化">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>
            </svg>
            <span>向量</span>
          </button>
          <button className="action-btn" onClick={handleSummarize} title="摘要">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <button className="action-btn action-btn-danger" onClick={handleDelete} title="删除消息">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
